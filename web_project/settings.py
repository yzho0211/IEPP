...
CSRF_TRUSTED_ORIGINS = [ 'https://sunsavvvy.azurewebsites.net','https://sunsavvvy.azurewebsites.net/home' ]
...
AZURE_CUSTOM_DOMAIN = f'storage444ie.blob.web_project.windows.net'
